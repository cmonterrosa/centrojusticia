...
//
//function link_select_to_editbox(select_id, editbox_id)
//{
//    selectElem = document.getElementById(select_id);
//    length = selectElem.options.length;
//
//    for(i = 0; i < length; i++){
//      item = selectElem.options[i];
//      if (item.value == 98 && item.selected) {
//        editboxElem = document.getElementById(editbox_id);
//        editboxElem.disabled = false;
//        break;
//      }
//    }
//}
